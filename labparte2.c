...
int main() {
    int *array;
    int tamanio_inicial = 5;   // Tama√±o inicial del array
    int nuevo_tamanio, i;
    ...
    // 2. Solicitar un nuevo tama√±o al usuario y reasignar la memoria (completar)
    printf("Ingresa el nuevo tamaÒo del array: ");
    scanf("%d", &nuevo_tamanio);
       if (nuevo_tamanio < 1) {  // ValidaciÛn de tamaÒo
